...
g++ -fpermissive -DNO_INCLUDE_TEMPSTRUCT -c  Trigonometric.cpp BMCANDefines.cpp BMUtility.cpp StringFunctions.cpp FileOperations.cpp   OtherCaplFunc.cpp CANCAPLWrapper.cpp Wrapper_Common.cpp 
